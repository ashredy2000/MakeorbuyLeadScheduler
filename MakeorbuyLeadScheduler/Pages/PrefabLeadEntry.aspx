<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PrefabLeadEntry.aspx.cs" Inherits="MakeorbuyLeadScheduler.WebForm2" %>
...
<table align="center" class="tablestyle" >
                    ...
                    <asp:Label ID="Label1" runat="server" 
                        style="font-size: xx-large; font-family: Verdana; color: #6f6f6f;" Text="Prefab Leads"></asp:Label>
                            </td>
                            <td align="center">
                                &nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            ControlToValidate="txt_enquiryname" CssClass="style34" 
                            ErrorMessage="RequiredFieldValidator" ForeColor="Red" 
                            ValidationGroup="submit">*</asp:RequiredFieldValidator></td>
                            <td>
                                &nbsp;</td>
