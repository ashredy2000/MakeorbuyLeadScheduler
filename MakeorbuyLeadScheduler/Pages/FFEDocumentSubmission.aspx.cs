...
{
    public partial class DocumentSubmitEntry : System.Web.UI.Page
    {
        ...
        public void Submit()
        {
            ...
            {
                String StrQuery = "INSERT INTO Mob_Lead_docSubmission(ClientName ,  LeadNo ,DocNo,DocName,  DateofSubmission ,Catagory,  Vide ,  FromWhom ,  EntryBy ,  DateofEntry )  VALUES ('" + ddl_clientname.Text + "', '" + ddl_leadno.Text + "','" + txt_docno.Text + "','" + txt_docname.Text + "','" + submissionDate + "','FFE','" + ddl_vide.Text + "','" + txt_fromwhom.Text + "','" + EntryBy + "','" + EntryTime + "')";
