...
{
    public partial class FFELeadSummary : System.Web.UI.Page
    {
        ...
        public void View()
        {
            ...
            string query = "Select Count(*) FROM Mob_Lead  where Catagory='FFE'";
            int rCnt;
            rCnt = 0;
            ...
            if (rCnt > 0)
            {
                string aStr = "Select * from Mob_Lead where Catagory='FFE' order by LeadDate ";
                OdbcDataReader dr;
