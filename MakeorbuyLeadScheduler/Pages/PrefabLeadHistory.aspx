<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="PrefabLeadHistory.aspx.cs" Inherits="MakeorbuyLeadScheduler.WebForm5" %>
...
<table align="center" class="tablestyle" >
                    ...
                    <asp:Label ID="Label1" runat="server" 
                        style="font-size: xx-large; font-family: Verdana; color: #6f6f6f;" 
                                    Text="Prefab Leads History"></asp:Label>
                            </td>
                            <td align="center" class="style103">
                                </td>
                        </tr>
