...
{
    public partial class RetailHousingLeadFollowUp : System.Web.UI.Page
    {
        ...
        public void Submit()
        {
            ...
            string companyname = "";
            string aStr = "Select CompanyName from Mob_Lead where LeadNo='"+ddl_leadno.Text+"' ";
                OdbcDataReader dr;
        ...
        protected void btn_submit0_Click(object sender, EventArgs e)
        {
            ...
            String StrQuery = "UPDATE LeadStatusReport SET Status= '" + ddl_bidding.Text + "',ReasonforBidding='" + biddingstrategy + "' where LeadNo='" + ddl_leadno0.Text + "' and Catagory='Retail Housing' ";
            OdbcCommand PQSCommand1 = new OdbcCommand(StrQuery, Maincon);
            PQSCommand1.ExecuteNonQuery();
            Page.ClientScript.RegisterStartupScript(this.GetType(), null, "confirmmessage()", true);
        }
