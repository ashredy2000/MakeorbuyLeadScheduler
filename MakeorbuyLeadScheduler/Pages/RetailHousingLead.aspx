<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RetailHousingLead.aspx.cs" Inherits="MakeorbuyLeadScheduler.Retail_Housing.RetailHousingLead" %>
        ...
        $("#txt_startdate").datepicker({ dateFormat: 'dd/mm/yy', minDate: new Date(1990, 6, 12) });
          ...
          <script type="text/javascript" language="JavaScript">
              function confirmmessage() {
                  ...
                  window.location = "RetailHousingLead.aspx";
              }
...
<table align="center" class="tablestyle" >
                    ...
                    <asp:Label ID="Label1" runat="server" 
                        style="font-size: xx-large; font-family: Verdana; color: #6f6f6f;" 
                                    Text="Retail Housing Leads"></asp:Label>
                            </td>
                            <td align="center">
                                &nbsp;</td>
                        </tr>
