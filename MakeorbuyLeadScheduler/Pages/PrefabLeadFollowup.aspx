<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="PrefabLeadFollowup.aspx.cs" Inherits="MakeorbuyLeadScheduler.WebForm4" %>
         ...
         $("#txt_followupdate").datepicker({ dateFormat: 'dd/mm/yy', minDate: new Date(1990, 6, 12) });
          ...
          <script type="text/javascript" language="JavaScript">
              function confirmmessage() {
                  ...
                  window.location = "PrefabLeadFollowup.aspx";
              }
...
<table align="center" class="tablestyle" >
                    ...
                    <asp:Label ID="Label1" runat="server" 
                        style="font-size: xx-large; font-family: Verdana; color: #6f6f6f;" 
                                    Text="Prefab Leads Follow Up"></asp:Label>
                            </td>
                            <td align="center">
                                &nbsp;</td>
                        </tr>
       ...
       <ajax:CascadingDropDown ID="ClientNameCascading" runat="server" Category="ClientName"
        ...
        ServiceMethod="BindClientNamedropdown" ServicePath="LeadWebservice.asmx">
                            ...
                            <td class="style108">
                                                <asp:LinkButton ID="LinkButton4" runat="server" 
                                                    PostBackUrl="~/Pages/PrefabLeadHistory.aspx">History</asp:LinkButton>
                            </td>
                            <td class="style108">
                                </td>
                        </tr>
       ...
       <ajax:CascadingDropDown ID="ddlLeadNoCascading" runat="server" 
                ...
                ServiceMethod="BindLeadNodropdown" ServicePath="LeadWebservice.asmx">
                    ...
                    <asp:FileUpload ID="inpAttachment0" runat="server" />
                        ...
                        <tr>
                            ...
                            <td align="center" class="style109" colspan="3">
       ...
       <ajax:CascadingDropDown ID="ddl_clientname0_CascadingDropDown" runat="server" Category="ClientName"
        ...
        ServiceMethod="BindClientNamedropdownP2" ServicePath="LeadWebservice.asmx">
       ...
       <ajax:CascadingDropDown ID="ddl_leadno0_CascadingDropDown" runat="server" 
                ...
                LoadingText="Loading Lead No..." PromptText="Select" 
                ServiceMethod="BindLeadNodropdownP2" ServicePath="LeadWebservice.asmx">
       </ajax:CascadingDropDown> 
                                        </td>
                                        <td>
                                            &nbsp;</td>
