<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RetailHousingDocSubmission.aspx.cs" Inherits="MakeorbuyLeadScheduler.Pages.RetailHousingDocSubmission" %>
         ...
         $("#txt_date").datepicker({ dateFormat: 'dd/mm/yy', maxDate: new Date, minDate: new Date(1990, 6, 12) });
          ...
          <script type="text/javascript" language="JavaScript">
              function confirmmessage() {
                  ...
                  window.location = "RetailHousingDocSubmission.aspx";
              }
